...
-- dunai-bayes
import qualified Data.MonadicStreamFunction.Bayes as MSFBayes
...
runPopulationCl nParticles resampler = MSFReader.readerS . MSFBayes.runPopulationS nParticles resampler . MSFReader.runReaderS
